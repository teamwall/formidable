(ns formidable.core
  (:require [formidable.render :as r]
            formidable.render.table
            formidable.render.div
            formidable.render.bootstrap
            formidable.render.bootstrap3
            formidable.render.inline
